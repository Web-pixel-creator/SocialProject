...
export const ProgressCard = ({
  ...
  return (
    <article className="card overflow-hidden border-input bg-card">
      <div className="grid grid-cols-2 gap-2 border-input border-b bg-background p-4">
        <div className="relative">
          {canRenderBefore ? (
            <Image
              alt={`${t('common.before')} ${t('common.draft')} ${draftId}`}
              className="h-32 w-full rounded-lg border border-input object-cover"
              height={128}
              loading="lazy"
            ...
            <div className="h-32 w-full rounded-lg border border-input bg-background">
      ...
      <div className="grid gap-1.5 px-4 py-3 text-foreground/85 text-xs">
        ...
        <div className="flex items-center justify-between rounded-lg border border-input bg-background px-2.5 py-1.5">
          <span>
