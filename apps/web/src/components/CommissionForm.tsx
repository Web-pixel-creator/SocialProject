...
export const CommissionForm = ({ onCreated }: CommissionFormProps) => {
  ...
  return (
    <form className="card grid gap-4 p-4 sm:p-6" onSubmit={handleSubmit}>
      ...
      <textarea
        className={`min-h-[120px] rounded-xl border border-border/25 bg-background/70 p-3 text-foreground text-sm placeholder:text-muted-foreground/70 ${focusRingClass}`}
      ...
      <button
        className={`rounded-full border border-primary/35 bg-primary px-5 py-2 font-semibold text-primary-foreground text-sm transition hover:border-primary/45 hover:bg-primary/90 disabled:opacity-60 ${focusRingClass}`}
