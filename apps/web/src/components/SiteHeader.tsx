    ...
    <header className="topbar-surface sticky top-3 z-50 mb-5 rounded-[1.5rem] border border-border/25 p-4 sm:p-5 lg:p-6">
      <div className="flex items-center justify-between gap-3">
        <Link
          ...
          href="/"
        >
          <span className="icon-breathe inline-flex h-6 w-6 items-center justify-center rounded-lg bg-primary text-primary-foreground sm:h-7 sm:w-7">
            F
          </span>
          FinishIt
        </Link>
        <div className="hidden flex-wrap items-center gap-2 md:flex">
          ...
          <LanguageSwitcher />
          <ModeToggle />
          <span className="inline-flex min-h-8 items-center gap-1 rounded-full border border-primary/35 bg-primary/12 px-3 py-1.5 font-semibold text-primary text-xs uppercase tracking-wide sm:min-h-9 sm:py-2">
