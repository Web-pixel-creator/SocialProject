  ...
  return (
    <div className="grid gap-3 rounded-2xl border border-border/45 bg-background/70 p-4 text-foreground/85 text-xs md:grid-cols-2 xl:grid-cols-4">
      <label className="grid gap-1">
        ...
        <select
          className="rounded-lg border border-border/55 bg-background/72 px-3 py-2 text-foreground text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-1.5">
        <span className="inline-flex w-fit items-center rounded-full border border-border/45 bg-background/58 px-2.5 py-1 text-[11px] sm:text-xs">
        ...
        {hasFilterPanel ? (
          ...
          >
            ...
            {hasActiveFilters ? (
              <span
                aria-hidden="true"
                className="ml-1 rounded-full border border-primary/35 bg-primary/15 px-1.5 py-0.5 text-[10px] text-primary"
              >
                {activeFilterCount}
              </span>
            ) : null}
      ...
      {hasSecondaryRow ? (
        <div className="no-scrollbar flex items-center gap-1.5 overflow-x-auto pr-1 pb-0.5">
          {hasActiveFilters ? (
            <span
              className="flex-shrink-0 rounded-full border border-border/45 bg-background/66 px-2.5 py-1 font-semibold text-[11px]"
...
export const FeedTabs = ({ isObserverMode = false }: FeedTabsProps) => {
  ...
  const morePanelContent = (
    <>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-border/30 border-t pt-2">
        <span
          className="rounded-full border border-border/55 bg-background/66 px-3 py-1 font-semibold text-[11px] text-muted-foreground"
          title={activeFilterPills.join(' | ')}
        >
  ...
  return (
    <section className="grid gap-5">
      <div className="grid gap-3">
          ...
          <div className="flex justify-end">
            {isMobileViewport ? (
              ...
              >
                ...
                <div className="absolute right-0 z-20 mt-2 grid min-w-[16rem] gap-2 rounded-2xl border border-border/35 bg-card/95 p-2.5 backdrop-blur-sm">
                  {morePanelContent}
                </div>
              </details>
            )}
        ...
        <div className="grid gap-2 rounded-2xl border border-border/35 bg-card/72 p-2.5 backdrop-blur-sm sm:p-3 lg:p-3.5">
          <div className="grid gap-2 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            <label className="group relative flex w-full min-w-0 items-center gap-2 rounded-full border border-border/45 bg-background/82 px-3.5 py-2 text-muted-foreground text-xs transition focus-within:border-primary/45 focus-within:bg-background hover:border-border/65 hover:bg-background/90">
              ...
              <button
                ...
                className={`inline-flex items-center gap-1 rounded-full px-3 py-1.5 font-semibold text-[11px] uppercase tracking-wide transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
                  density === 'comfort'
                    ...
                    : 'border border-border/45 bg-background/40 text-muted-foreground hover:border-border/70 hover:text-foreground'
                }`}
        ...
        if (visibleItems.length === 0) {
          return (
            <div className="card grid gap-4 p-6 text-foreground/85 text-sm">
              ...
              {hasActiveFilters ? (
                <div className="grid gap-2 rounded-xl bg-background/60 p-3">
              ...
              <div className="flex flex-wrap gap-2">
                {active === 'Battles' ? (
                  ...
                  <>
                    ...
                    <Link
                      className="rounded-full border border-border/45 bg-background/60 px-4 py-2 font-semibold text-foreground text-xs transition hover:border-primary/40 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                      href="/search"
                    >
      ...
      {!(loading || fallbackUsed || hasMore) && visibleItems.length > 0 ? (
        <div
          className="inline-flex w-fit items-center rounded-full border border-border/45 bg-background/70 px-3 py-1 text-muted-foreground text-xs"
