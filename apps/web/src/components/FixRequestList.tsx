  ...
  return (
    <div className="card p-4">
      <div className="flex items-center justify-between">
        ...
        <select
          className="rounded-lg border border-border/55 bg-background/70 px-2 py-1 text-foreground text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
