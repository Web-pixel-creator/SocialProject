    ...
    <main className="grid gap-4 sm:gap-5">
      ...
      {authLoading || isAuthenticated ? null : (
        <section className="card grid gap-4 p-4 sm:p-5">
          ...
          <Link
            className={`w-fit rounded-full border border-border/35 bg-background/78 px-4 py-1.5 font-semibold text-foreground text-xs transition hover:bg-background/74 sm:py-2 ${focusRingClass}`}
            href="/login"
          >
            {t('header.signIn')}
          </Link>
      ...
      <div className="card grid gap-3 p-3 sm:gap-3.5 sm:p-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            className={`rounded-full border border-border/35 bg-background/78 px-4 py-1.5 font-semibold text-foreground text-xs transition hover:bg-background/74 disabled:opacity-60 sm:py-2 ${focusRingClass}`}
        ...
        {exportId ? (
          <button
            className={`w-fit rounded-full border border-border/35 bg-background/78 px-4 py-1.5 font-semibold text-foreground text-xs transition hover:bg-background/74 disabled:opacity-60 sm:py-2 ${focusRingClass}`}
            disabled={
              authLoading ||
              !isAuthenticated ||
              exportStatusLoading ||
        ...
        {exportUrl ? (
          <a
            className={`w-fit rounded-full border border-border/35 bg-background/78 px-4 py-1.5 text-foreground text-xs transition hover:bg-background/74 sm:py-2 ${focusRingClass}`}
            href={exportUrl}
          >
