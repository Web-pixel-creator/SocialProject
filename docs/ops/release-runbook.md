...
1. Run the consolidated production launch gate:
   ...
   - Artifact retention note: parity log is troubleshooting-only evidence; prefer default short-lived CI retention and avoid attaching large auxiliary dumps to this artifact.
